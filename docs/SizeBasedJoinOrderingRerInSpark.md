...
Provide the jar spark-radiant-sql-1.0.2.jar in the class path for the spark Application. For eg using --jars etc.

or

using --packages -> for jars(spark-radiant-sql-1.0.2.jar) published to maven central
